    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header">
            	...
            	<div class="box-tools">
                <!--    <a href="<?php echo site_url('evraklar/evrak_ekle/'.$this->uri->segment("3").''); ?>" class="btn btn-success btn-sm">Add</a>  -->
                </div>
            </div>
            <div class="box-body">
                <table class="table table-striped">
                    ...
                    <tr>
						...
						<td>
                            <a href="<?php echo site_url('evraklar/evrak_ekle/'.$e['evrak_id']); ?>" class="btn btn-info btn-xs"><span class="fa fa-pencil"></span> Edit</a> 
