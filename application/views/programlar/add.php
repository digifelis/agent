<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
            ...
            <?php echo form_open('programlar/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="fakulte" class="form-control">
								...
								{
									$selected = ($fakulte['fakulte_id'] == $this->input->post('fakulte')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="bolum" class="form-control">
								...
								{
									$selected = ($bolum['bolum_id'] == $this->input->post('bolum')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="fiyat" value="<?php echo $this->input->post('fiyat'); ?>" class="form-control" id="fiyat" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="egit_sure" class="control-label">Program Duration</label>
						<div class="form-group">
							<input type="text" name="egit_sure" value="<?php echo $this->input->post('egit_sure'); ?>" class="form-control" id="egit_sure" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="egit_dili" class="control-label">Program Language</label>
						<div class="form-group">
							<input type="text" name="egit_dili" value="<?php echo $this->input->post('egit_dili'); ?>" class="form-control" id="egit_dili" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="aciklama" class="control-label">Description</label>
						<div class="form-group">
							<textarea name="aciklama" class="form-control" id="aciklama"><?php echo $this->input->post('aciklama'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
