    ...
    <div class="col-md-12">
		...
		<a href="<?php echo site_url('ogrenci/index'); ?>" class="btn btn-success btn-sm">Back</a>
			...
			if(count($tercihler) > 0) {
				echo "Öğrenci Seçtiği Bölüm Bilgisi : <br>";
								foreach($tercihler as $tercih)
								{
									echo "Fakülte : ".$tercih['fakulte_adi'].'<br>Bölüm : '.$tercih['bolum_adi'].'<br>Eğtim Dili : '.$tercih['egitim_dili'].'<br>Başvuru Tarihi : '.$tercih['zaman'].'<br>';
								} 
								if ($yetki < 3) {
									if($ogrenci['durum'] != 3 and $ogrenci['durum'] != 6 ){
			...
			<?php echo form_open('ogrenci/edit/'.$ogrenci['ogrenci_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						<label for="adi_soyadi" class="control-label">Name Student</label>
						<div class="form-group">
       ...
       <div class="col-md-6">
          ...
          <div class="col-md-6">
						...
						<div class="form-group">
						  <input type="text" name="dogum_tarihi" value="<?php echo ($this->input->post('dogum_tarihi') ? $this->input->post('dogum_tarihi') : $ogrenci['dogum_tarihi']); ?>" class="form-control" id="dogum_tarih" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask=""  />
						</div>
					</div>   
                    <!--
                               <div class="col-md-6">
                    ...
                    -->
						...
						<div class="form-group">
						  <input type="text" name="ulke" value="<?php echo ($this->input->post('ulke') ? $this->input->post('ulke') : $ogrenci['ulke']); ?>" class="form-control" id="ulke" />
						</div>
					</div>   
                    ...
                    <div class="col-md-6">
						...
						<p>Rejection reason is going to be posted here. </p>
						<div class="form-group">
                        <textarea name="aciklama" cols="80" rows="5"></textarea>
