<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
            ...
            <?php echo form_open('ogrenci/acenta_add'); ?>
          	<div class="box-body">
       ...
       <div class="col-md-6">
          ...
          <div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="dogum_tarihi" value="<?php echo $this->input->post('dogum_tarihi'); ?>" class="form-control" id="datepicker"  data-inputmask="'alias': 'yyyy/mm/dd'" data-mask=""  />
					...
					<div class="col-md-6">
                        ...
                        <textarea class="form-control" name="adres"></textarea>
                           ...
                           <div class="col-md-6">
						<label for="posta_kodu" class="control-label">Zip Code</label>
						<div class="form-group">
